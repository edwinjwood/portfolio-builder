  ...
  return (
    <main className="w-full h-full grid place-items-center font-sans text-gray-900 dark:text-gray-100">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-700 dark:text-gray-200 mb-4 font-semibold">Create your portfolio website easily with AI and publish to the cloud.</p>
        <p className="text-base text-gray-500 dark:text-gray-400 mb-8 max-w-xl mx-auto">
          Facet lets you build a beautiful, professional portfolio in minutes. Choose a template, describe your experience, and let AI do the rest. Instantly publish your site to the cloud and share your story with the world.
        </p>
